  ...
  let price = 1
    ...
    return (
      <div className="flex flex-col items-center px-4">
        ...
        <Pricing service="/test-product" heading={pricingHeading} title={pricingTitle} subTitle={pricingSubTitle} subHeading={pricingSubHeading} features={pricingFeatures} price={price} beforeDiscount={1}/>
      </div>
    )
  }