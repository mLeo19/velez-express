...
export const Receipt = ({ c_email, c_name } : ReceiptProps) => {
  return (
    <section className=' text-left my-12 px-6'>
      <div className='sm:px-0'>
        <h3 className='text-base font-semibold leading-7'>Payment Information</h3>
        <p className='mt-1 max-w-2xl text-sm leading-6'> General details for registration</p>
      </div>
      ...
      <dl className="divide-y divide-gray-100">
        ...
        <div className='py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0'>
          ...
          <dd className="mt-1 text-sm leading-6 sm:col-span-2 sm:mt-0">$600.00</dd>
        </div>
      </dl>
      </div>
    </section>
